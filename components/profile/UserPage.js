// import { Text, View, Pressable, Animated, ScrollView, ActivityIndicator } from 'react-native';
// import React, { useContext, useState, useEffect, useRef } from 'react';
// import tw from 'tailwind-react-native-classnames';
// import TabContent from './TabContent';
// import { getFollowersCount, getFollowingCount, followUser, unfollowUser, addUserPostsToFeedInChunks, removeUserPostsFromFeedInChunks } from '../../api/userRelations.js';
...
//           contentContainerStyle={{ flexGrow: 1, paddingTop:80, paddingBottom: 80 }}
...
//                 <Text style={[tw`text-lg font-bold text-white`, {color: '#6abdff'}]}>{userData.name}</Text>
...
//                     <Pressable
//                       style={[tw`w-80 h-10 rounded-lg`, { backgroundColor: isFollowed ? '#ff0000' : '#6abdff' }]}
//                       onPress={handleFollow}
//                     >
//                       <Text style={tw`text-center font-bold text-white pt-3`}>{isFollowed? 'Following' : 'Follow'}</Text>
//                     </Pressable>
//                 </Animated.View>
//             </View>
