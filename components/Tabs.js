                    ...
                    >
                            ...
                            options={{
                                tabBarIcon: ({ focused }) => (
                                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                                        <FontAwesome name="home" size={24} color={focused ? '#ff0000' : '#6abdff'} />
                                    </View>
                                ),
                                headerShown: false
                            }}
                        ...
                        <Tab.Screen
                            ...
                            options={{
                                tabBarIcon: ({ focused }) => (
                                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                                        <FontAwesome name="search" size={24} color={focused ? '#ff0000' : '#6abdff'} />
                                    </View>
                                ),
                                headerShown: false
                            }}
                        ...
                        <Tab.Screen
                            ...
                            options={{
                                tabBarIcon: ({ focused }) => (
                                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                                        <MaterialCommunityIcons name="account" size={24} color={focused ? '#ff0000' : '#6abdff'} />
                                    </View>
                                ),
                                headerShown: false
                            }}
